...
const predictionImg = cv.imread(path.join(__dirname, 'images/toSearch', 'IMG_20181221_201717_1.jpg'));

// other images of Eleven's face
const imagesPaths = [
  path.join(__dirname, 'images/Elisa', 'elisa_7.jpg'),
  path.join(__dirname, 'images/Elisa', 'elisa_2.jpg'),
  path.join(__dirname, 'images/Elisa', 'elisa_5.jpg'),
  path.join(__dirname, 'images/Elisa', 'elisa_6.jpg'),
];
// array of images
